 ...
 */
public class BehalfDeliveryFragment extends BaseFragment {
    ...
    protected void init(View view) {
        ...
        favorite_pic.setImageResource(R.drawable.b_5);
    ...
    public int getResourcesLayout() {
        return R.layout.fragment_behalf_delivery;
    }
}

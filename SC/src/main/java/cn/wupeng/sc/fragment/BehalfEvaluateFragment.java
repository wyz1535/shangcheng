 ...
 */
public class BehalfEvaluateFragment extends BaseFragment {
    ...
    protected void init(View view) {
        ...
        favorite_pic.setImageResource(R.drawable.b_2);
    ...
    public int getResourcesLayout() {
        return R.layout.fragment_behalf_evaluate;
    }
}
